            ...
            <div className="col-md-6 col-sm-12 d-flex flex-column">
                ...
                <div className="card my-3">
                    <div className="card-body">
                        ...
                        A camisa preta é confeccionada em um tecido de alta qualidade, com uma textura suave e um acabamento fosco elegante que reflete discrição e estilo. Nas costas, há um leve recorte central que ajuda na mobilidade e no ajuste perfeito ao corpo. O tecido é respirável e de fácil manutenção, com propriedades que evitam amassados, tornando a peça prática para o dia a dia ou viagens. Internamente, as costuras são reforçadas e bem acabadas, garantindo durabilidade e conforto ao longo do uso.
                        </p>
                    </div>
                </div>
